           ...
           <div className="grid md:grid-cols-3 gap-8">
             ...
             <div className="flex flex-col items-center space-y-4 animate-fade-in-up delay-200">
              ...
              <div className="flex flex-col items-center space-y-4 animate-fade-in-up delay-300">
               <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-briefcase-business text-accent"><path d="M12 12h.01"/><path d="M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><path d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/><path d="M8 12a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/><path d="M16 12a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/><path d="M12 16.5c-2 0-2.5-1.5-5-1.5"/><path d="M12 16.5c2 0 2.5-1.5 5-1.5"/></svg>
