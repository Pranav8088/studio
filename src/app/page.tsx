...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      {/* Hero Section */}
      <section id="home" className="relative pt-20 pb-12 md:pt-32 md:pb-20 lg:pt-40 lg:pb-28 bg-gradient-to-b from-primary/5 via-background to-background flex items-center overflow-hidden min-h-[calc(85vh)]">
        <div className="absolute top-0 left-0 w-64 h-64 bg-accent/5 rounded-full filter blur-3xl opacity-40 -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
        <div className="absolute bottom-0 right-0 w-72 h-72 bg-primary/5 rounded-full filter blur-3xl opacity-40 translate-x-1/3 translate-y-1/3 pointer-events-none"></div>
              ...
              <CarouselContent>
                <CarouselItem>
                  <Image
                    ...
                    className="rounded-xl shadow-2xl object-cover w-full aspect-[6/5]"
                  />
                </CarouselItem>
                 <CarouselItem>
                  <Image
            ...
            <div className="container max-w-7xl grid lg:grid-cols-2 gap-12 items-center px-4 md:px-6">
                <div className="animate-fade-in-left">
                    <Image
                        ...
                        alt="Nitya Marketing Team Meeting"
        ...
        <section id="values-snippet" className="py-16 md:py-24 bg-secondary">
            <div className="container max-w-7xl text-center px-4 md:px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                 ...
                 <Link href="/about#values" className="inline-block mt-12"> {/* Link to specific section if possible or just /about */}
       ...
       <section id="featured-services" className="py-16 md:py-24 bg-background">
         <div className="container max-w-7xl text-center px-4 md:px-6">
           ...
           <p className="text-lg text-muted-foreground mb-12 max-w-3xl mx-auto">
             Driving growth through specialized B2B marketing solutions.
           </p>
           <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
             {featuredServices.map((service, index) => (
                 <Card key={index} className="flex flex-col text-left hover:shadow-lg transition-shadow duration-300 animate-fade-in-up" style={{ animationDelay: `${index * 150}ms` }}>
                   <CardHeader className="flex flex-row items-center gap-4 pb-4">
                    ...
                    <div className="p-6 pt-0">
                         <Link href={service.link}>
                           <Button variant="link" className="p-0 h-auto text-accent">View Service <ArrowRight className="ml-1 h-4 w-4" /></Button>
                         </Link>
                     </div>
                 </Card>
             ))}
           </div>
            <Link href="/services" className="inline-block mt-12">
        ...
        <section id="blog-snippet" className="py-16 md:py-24 bg-secondary">
            <div className="container max-w-7xl px-4 md:px-6">
                <div className="text-center mb-12">
                     ...
                     <p className="text-lg text-muted-foreground mt-2">Stay updated with B2B marketing trends and tips.</p>
                </div>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {blogPosts.map((post, index) => (
                         <Card key={post.id} className="flex flex-col overflow-hidden hover:shadow-xl transition-shadow duration-300 animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
                            ...
                            <div className="p-6 pt-0">
                                <Link href={post.link}>
                                    <Button variant="link" className="p-0 h-auto text-accent">Read More <ArrowRight className="ml-1 h-4 w-4" /></Button>
                                </Link>
                            </div>
                         </Card>
                    ))}
